...
?>
<?php
$query_DatosCourse_edit = sprintf("SELECT * FROM courses WHERE category = 1 AND status = 1 ORDER BY id_course ASC"); 
...
$query_DatosCourse2_edit = sprintf("SELECT * FROM courses WHERE category = 1 AND status = 1 ORDER BY id_course ASC"); 
...
$query_DatosCourse3_edit = sprintf("SELECT * FROM courses WHERE category = 1 AND status = 1 ORDER BY id_course ASC"); 
...
$query_DatosCourse4_edit = sprintf("SELECT * FROM courses WHERE category = 1 AND status = 1 ORDER BY id_course ASC"); 
...
$query_DatosSpecialCourse_edit = sprintf("SELECT * FROM courses WHERE category > 1 AND status = 1 ORDER BY id_course ASC"); 
$DatosSpecialCourse_edit = mysqli_query($con, $query_DatosSpecialCourse_edit) or die(mysqli_error($con));
$row_DatosSpecialCourse_edit = mysqli_fetch_assoc($DatosSpecialCourse_edit);
$totalRows_DatosSpecialCourse_edit = mysqli_num_rows($DatosSpecialCourse_edit);
?>
<?php
...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "formeditc")) {
     $updateSQL = sprintf("UPDATE inscriptions SET package=%s, course_1=%s, course_2=%s, course_3=%s, course_4=%s, course_s1=%s, status=%s WHERE id_student=%s",
                          GetSQLValueString($_POST["package"], "int"),
                          GetSQLValueString($_POST["course_1"], "int"),
                          GetSQLValueString($_POST["course_2"], "int"),
                          GetSQLValueString($_POST["course_3"], "int"),
...
<body>
    <div class="wrapp">
        ...
        <div class="container">
          ...
          <?php include("inc/students_list_old.php"); ?>
        </div>
    </div>
</body>
</html>
