    ...
    <div class="subform_cont1">
        <form action="publications.php" method="post" name="formrequest" id="formrequest">
            <table class="formulario" border="0" cellspacing="0" cellpadding="0" style="width:600px; margin-bottom:0;">
                ...
                <tr height="60">
                    <td colspan="3" valign="middle" align="center"><input class="textf" type="text" placeholder="Title..." name="title" id="title" size="76" required/></td>
                </tr>
                <tr height="100">
                ...
                <tr height="50">
                    <td width="33.33%" valign="middle" align="right" style="color: #666; font-size: 14px; padding: 0 10px;">
                        foto setting:
                    ...
                    <td width="33.33%" valign="middle" align="left" style="color: #666; font-size: 14px; padding: 0 10px;">
                        Status:
    ...
    <div class="subform_cont1">
        <form action="publications.php" method="post" name="formedit" id="formedit">
            <table class="formulario" border="0" cellspacing="0" cellpadding="0" style="width:600px; margin-bottom:0;">
                ...
                <tr height="60">
                    <td colspan="3" valign="middle" align="center"><input class="textf" type="text" value="<?php echo $row_DatosEdit['title'];?>" placeholder="Title..." name="title" id="title" size="76" required/></td>
                </tr>
                <tr height="100">
                    <td colspan="3" valign="middle" align="center"><textarea class="textf" type="text" placeholder="Content..." name="content" id="content" maxlength="2000" cols="65" rows="8" required><?php echo $row_DatosEdit['content'];?></textarea></td>
                </tr>
                <tr height="200">
                    <td colspan="3" valign="middle" align="center">
                ...
                <tr height="50">
                    ...
                    <td width="33.33%" valign="middle" align="center" style="color: #666; font-size: 14px; padding: 0 10px;">
                        ...
                        <option value="4" <?php if ($row_DatosEdit["site"]=="2") echo "selected"; ?>>PR Publication</option>
                        </select>
                    </td>
                    <td width="33.33%" valign="middle" align="left" style="color: #666; font-size: 14px; padding: 0 10px;">
                        Status:
