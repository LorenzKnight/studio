...
<?php if($_GET["see"]):?>
    <div class="subform_cont1">
        <form id="formart">
            <table class="popwindows" style="width: 500px; margin: 70px auto;" border="0" cellspacing="0" cellpadding="0">
                <tr height="60">
                    <td colspan="2" valign="middle" align="center">
            ...
            <table class="formulario" border="0" cellspacing="0" cellpadding="0">
                ...
                <tr height="60">
                    <td colspan="2" valign="middle" align="center" style="color: #333; padding: 30px 0 0 0;">
                        ...
                        <option value="1" <?php if ($row_DatosConsulta['status'] == 1) echo "selected"; ?>>Activ</option>
                        <option value="0" <?php if ($row_DatosConsulta['status'] == 0) echo "selected"; ?>>Inactiv</option>
                        </select>
                    </td>
                </tr>
                <tr height="80">
