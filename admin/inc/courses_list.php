...
if (isset($VARIABLE)) {
 ...
 $query_DatosConsulta = sprintf("SELECT * FROM package ORDER BY id_package"); 
...
<table width="100%" cellspacing="0" class="table_user" style="background-color: #F7B500;margin: 20px auto 0; ">
    <tr height="40" style="color: #FFF;">
        <td width="16.66%" nowrap="nowrap" align="left" style="padding: 0 0 0 20px; border-bottom: 1px solid #F7B500;">Name</td>
        <td width="23.32%" nowrap="nowrap" align="left" style="padding: 0 0 0 20px; border-bottom: 1px solid #F7B500;">Descriptions</td>
        <td width="10%" nowrap="nowrap" align="center" style="padding: 0 0 0 0; border-bottom: 1px solid #F7B500;">Price</td>
        <td width="16.66%" nowrap="nowrap" align="center" style="padding: 0 0 0 0; border-bottom: 1px solid #F7B500;">registration date</td>
        <td width="16.66%" nowrap="nowrap" align="center" style="padding: 0 0 0 0; border-bottom: 1px solid #F7B500;">Status</td>
...
<table width="100%" cellspacing="0" class="table_user" style="margin: 0 auto 15px; box-shadow: 0 .15rem 2rem 0 rgba(58,59,69,.15)!important;">
    <tr class="line" height="60">
        <td width="16.66%" nowrap="nowrap" align="left" style="padding: 0 0 0 20px;"><?php echo $row_DatosConsulta['package_name']; ?></td>
        <td width="23.32%" nowrap="nowrap" align="left" style="padding: 0 0 0 20px;"><?php echo $row_DatosConsulta['description']; ?></td>
        <td width="10%" nowrap="nowrap" align="center" style="padding: 0 0 0 0;"><?php echo $row_DatosConsulta['price']; ?></td>
        <td width="16.66%" nowrap="nowrap" align="center" style="padding: 0 0 0 0;"><?php echo $row_DatosConsulta['date']; ?></td>
        <td width="16.66%" nowrap="nowrap" align="center" style="padding: 0 0 0 0;"><?php echo $row_DatosConsulta['status']; ?></td>
        ...
        <div class="arternative">
            ...
            <div class="arternative-content">
                <a href="courses.php?editc=<?php echo $row_DatosConsulta['id_package']; ?>" class="alt_button">Edit course</a>
                <a href="course_delete.php?id=<?php echo $row_DatosConsulta['id_package']; ?>" class="alt_button">Delete</a>
            </div>
        </div>
        </td>
    </tr>
      ...
      <table class="formulario" border="0" cellspacing="0" cellpadding="0">
          ...
          <tr height="80">
              <td colspan="2" valign="middle" align="center" style="color: #666; font-size: 14px;">
                      <a href="courses.php"><input class="button_a" style="width: 170px; text-align: center;" value="avbryt" /></a> <input type="submit" class="button" value="Anmäla mig" />
              </td>
          </tr>
          <tr height="30">
              <td colspan="2" width="100%" valign="middle" align="center" style="color: #666; font-size: 14px; padding: 0 10px;">
