...
<div class="space">
    <div class="text_div" style="border-bottom: 1px solid rgba(201,172,140,1);">
        <div class="heading">
            ...
            <p style="color: rgba(201,172,140,1);">- Här är lite info som är kanske bra att veta! -</p>
        </div>

        <div class="beginfo">
            <h3 style="text-transform:uppercase;">GRATIS PROVA-PÅ</h3>
            <p>Innan (eller första veckan??) varje termin så har vi en gratis prova-på-vecka.</p>
        </div>
        <div class="beginfo">
            <h3 style="text-transform:uppercase;">DROP-IN</h3>
            <p>Enskilda klasser utan föranmälan, betalas i entrén.
            (I mån av plats, ej tillgänglig för fullbokade klasser) 150 kr</p>
        </div>
        <div class="beginfo">
            <h3 style="text-transform:uppercase;">PRACTICA</h3>
            <p>Övningstillfällen i samband med kurser, endast öppet för kursdeltagare.
            För mer information kring vilka övningstillfällen som ingår i ditt paket se ”Kurser & paket”.</p>
        </div>
        <div class="beginfo">
        ...
        <div class="beginfo">
            ...
            <p>Vill du hellre ta privatlektioner? Varje vecka erbjuder vi privatlektioner i flertalet kurser för både enskilda personer och par. 
    ...
    <div class="text_div" style="border-bottom: 1px solid rgba(201,172,140,1);">
        <div class="heading">
            ...
            <p >Hos oss hittar du kurser i flera olika dansstilar och på olika nivåer som passar allt från nybörjare till erfarna dansare. 
            Hit kan du anmäla dig själv eller tillsammans med vänner och/eller en danspartner. 
            Våra klasser är välkomnade och sociala och du kommer lära känna andra dansare under kursens gång.</p>
            <br>
